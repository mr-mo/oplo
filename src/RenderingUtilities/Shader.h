...
public:
	...
	bool Compile( Target target, const std::string& fn );
	bool Compile( Target target, const std::vector< std::string >& fn );
...
public:
	...
	bool Compile( Target target, unsigned input_type, unsigned output_type, unsigned output_count, const std::string& fn );
	bool Compile( Target target, unsigned input_type, unsigned output_type, unsigned output_count, const std::vector< std::string >& fn );
